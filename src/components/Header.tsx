...
const Header = () => {
  ...
  const disableNavbarHide = false; // Based on the original HTML, this is a static value for this page
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link to="/search" className="text-sm font-medium text-gray-600 hover:text-black transition-colors">
              Find Talent
            </Link>
            <div className="flex items-center gap-4">
              <Link to="/accounts/login" className="text-sm font-semibold text-gray-900 hover:text-gray-600 transition-colors">
                Log in
              </Link>
              <Link
                to="/accounts/signup"
