      ...
      <main className="flex-grow w-full max-w-7xl mx-auto px-4 my-8 sm:px-6 lg:px-8 z-0 relative">
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 bg-white border rounded-lg p-6 shadow-sm">
            ...
            >
              {isLoading ? (
                ...
                formValidationReason || 'Create Influencer Account'
              )}
            </button>
          </form>
          ...
          <p className="text-sm text-gray-600 mt-4 text-center">
            ...
            <Link className="text-black underline font-medium hover:no-underline" to="/accounts/signup/client">Sign up as Client</Link>
          </p>
        </div>
      </main>
      <Footer />
